...
class TestApp(TestCase):
    ...
    def test_greet_page(self):
        response = self.client.post(url_for('greet'), data={'name': 'John', 'age': 25, 'dob': '25-07-1992', 'city': 'Groningen', 'gender': 'male'}, follow_redirects=True)
        self.assert200(response)
        self.assertIn(b"Hello, John!", response.data)
        self.assertIn(b"You are 25 years old and you are born on 25-07-1992.", response.data)
